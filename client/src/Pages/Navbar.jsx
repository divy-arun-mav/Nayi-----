...
const Navbar = () => {
    ...
    const navigationOrg = [
        ...
        { title: 'Submit Report', path: '/submitreport/:id' },
            ...
            <nav className={`fixed top-0 border-r border-r-white left-0 h-full w-64 bg-gray-900 transform ${state ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:translate-x-0 z-40`}>
                <div className="p-4">
                    <ul className="space-y-4">
                        <li className="flex justify-center align-middle text-2xl font-bold items-center text-white gap-1 py-7">
                        ...
                        <li>
                            <button
                                ...
                                className="flex items-center py-3 px-5 font-medium text-center text-green-600 border border-green-600 bg-transparent hover:bg-green-600 hover:text-white active:text-white active:bg-blue-700 rounded-lg shadow-lg cursor-pointer transition-colors duration-300 mb-3"
                            >
